    ...
    \cventry
      ...
      {Jan. 2017} % Date(s)
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          ...
          \item {Traced the impact of the Cuban revolution through to the modern day, in an attempt to highlight its influence on the Cuban state, U.S.-Cuban relations, and Cuba's role in current regional politics.}
        \end{cvitems}
      }
