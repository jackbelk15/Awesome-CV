    ...
    \cventry
      ...
      {Jun. 2018 - Present} % Date(s)
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          \item {Co-authored \emph{Social Connectedness and Political Behavior in the 2016 United States Election: A Replication and Extension} with Prof. Jack L Reilly and developed materials for presentation at the 2018 Political Networks Conference in Arlington, VA.}
...
%---------------------------------------------------------
    \cventry
      ...
      {
        \begin{cvitems} % Description(s) of tasks/responsibilities
          \item {Planned and coordinated multiple excersizes, workshops, and in class discussions on topics covered in American government and quantitative social science methods courses.}
